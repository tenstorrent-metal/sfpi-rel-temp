...
#endif
#ifdef GENERATOR_FILE
extern int rvtt_replay_buffer_size;
#else
  int x_rvtt_replay_buffer_size;
#define rvtt_replay_buffer_size global_options.x_rvtt_replay_buffer_size
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_blackhole;
#else
  int x_flag_blackhole;
#define flag_blackhole global_options.x_flag_blackhole
#endif
#ifdef GENERATOR_FILE
...
#define OPTION_MASK_RVTT_BH (1U << 0)
...
#define TARGET_RVTT_BH ((flag_blackhole & OPTION_MASK_RVTT_BH) != 0)
#define TARGET_RVTT_BH_P(flag_blackhole) (((flag_blackhole) & OPTION_MASK_RVTT_BH) != 0)
...
enum opt_code
{
  ...
  OPT_frvtt_sfpu_replay_buffer_size_ = 1331, /* -frvtt-sfpu-replay-buffer-size= */
  OPT_frvtt_sfpu_warn = 1332,                /* -frvtt-sfpu-warn */
  OPT_fsanitize_address_use_after_scope = 1333,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1334,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1335,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1336,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1337,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1338,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1339,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1340,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1341, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1342,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1343,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1344,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1345,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1346,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1347,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1348,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1349,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1350,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1351,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1352,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1353,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1354,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1355,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1356,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1357,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1358, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1359,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1360,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1361,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1362,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1363,               /* -fsection-anchors */
  /* OPT_fsee = 1364, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1365,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1366,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1367,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1368,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1369,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1370,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1371,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1372,                   /* -fshort-enums */
  OPT_fshort_wchar = 1373,                   /* -fshort-wchar */
  OPT_fshow_column = 1374,                   /* -fshow-column */
  OPT_fshrink_wrap = 1375,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1376,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1377,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1378,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1379,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1380,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1381,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1382,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1383,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1384,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1385,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1386,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1387,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1388,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1389,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1390,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1391,                      /* -fsquangle */
  OPT_fssa_backprop = 1392,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1393,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1394,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1395,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1396, */             /* -fstack-check */
  OPT_fstack_check_ = 1397,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1398,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1399,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1400,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1401,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1402,               /* -fstack-protector */
  OPT_fstack_protector_all = 1403,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1404,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1405,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1406,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1407,                   /* -fstack-usage */
  OPT_fstats = 1408,                         /* -fstats */
  OPT_fstdarg_opt = 1409,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1410,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1411, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1412,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1413,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1414,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1415,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1416,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1417, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1418,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1419,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1420,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1421,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1422,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1423, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1424,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1425, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1426,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1427, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1428,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1429,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1430,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1431,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1432,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1433,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1434,                   /* -ftime-report */
  OPT_ftime_report_details = 1435,           /* -ftime-report-details */
  OPT_ftls_model_ = 1436,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1437,              /* -ftoplevel-reorder */
  OPT_ftracer = 1438,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1439,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1440,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1441,                   /* -ftrampolines */
  OPT_ftransition_all = 1442,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1443,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1444,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1445,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1446,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1447,              /* -ftransition=field */
  OPT_ftransition_import = 1448,             /* -ftransition=import */
  OPT_ftransition_nogc = 1449,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1450,                /* -ftransition=tls */
  OPT_ftrapping_math = 1451,                 /* -ftrapping-math */
  OPT_ftrapv = 1452,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1453,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1454,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1455,                      /* -ftree-ccp */
  OPT_ftree_ch = 1456,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1457, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1458,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1459,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1460, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1461,                   /* -ftree-cselim */
  OPT_ftree_dce = 1462,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1463,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1464,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1465,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1466,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1467, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1468,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1469,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1470, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1471,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1472,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1473, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1474,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1475,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1476,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1477,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1478,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1479,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1480,                      /* -ftree-pre */
  OPT_ftree_pta = 1481,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1482,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1483, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1484,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1485,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1486,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1487,                     /* -ftree-slsr */
  OPT_ftree_sra = 1488,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1489, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1490, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1491,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1492,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1493,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1494, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1495,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1496, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1497,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1498,         /* -funconstrained-commons */
  OPT_funderscoring = 1499,                  /* -funderscoring */
  OPT_funit_at_a_time = 1500,                /* -funit-at-a-time */
  OPT_funittest = 1501,                      /* -funittest */
  OPT_funroll_all_loops = 1502,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1503,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1504,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1505, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1506,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1507,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1508,                 /* -funsigned-char */
  OPT_funswitch_loops = 1509,                /* -funswitch-loops */
  OPT_funwind_tables = 1510,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1511,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1512,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1513,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1514,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1515,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1516,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1517,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1518,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1519,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1520,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1521,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1522, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1523,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1524,                   /* -fverbose-asm */
  /* OPT_fversion = 1525, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1526,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1527,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1528,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1529,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1530,                   /* -fvisibility= */
  OPT_fvpt = 1531,                           /* -fvpt */
  OPT_fvtable_gc = 1532,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1533,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1534,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1535,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1536,                     /* -fvtv-debug */
  OPT_fweak = 1537,                          /* -fweak */
  OPT_fweb = 1538,                           /* -fweb */
  /* OPT_fwhole_file = 1539, */              /* -fwhole-file */
  OPT_fwhole_program = 1540,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1541,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1542,             /* -fworking-directory */
  OPT_fwpa = 1543,                           /* -fwpa */
  OPT_fwpa_ = 1544,                          /* -fwpa= */
  OPT_fwrapv = 1545,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1546,                 /* -fwrapv-pointer */
  OPT_fxref = 1547,                          /* -fxref */
  /* OPT_fzee = 1548, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1549,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1550,                     /* -fzero-link */
  OPT_g = 1551,                              /* -g */
  OPT_gant = 1552,                           /* -gant */
  OPT_gas_loc_support = 1553,                /* -gas-loc-support */
  OPT_gas_locview_support = 1554,            /* -gas-locview-support */
  OPT_gcoff = 1555,                          /* -gcoff */
  OPT_gcoff1 = 1556,                         /* -gcoff1 */
  OPT_gcoff2 = 1557,                         /* -gcoff2 */
  OPT_gcoff3 = 1558,                         /* -gcoff3 */
  OPT_gcolumn_info = 1559,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1560,                 /* -gdescribe-dies */
  OPT_gdwarf = 1561,                         /* -gdwarf */
  OPT_gdwarf_ = 1562,                        /* -gdwarf- */
  OPT_gen_decls = 1563,                      /* -gen-decls */
  OPT_ggdb = 1564,                           /* -ggdb */
  OPT_ggnu_pubnames = 1565,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1566,                   /* -gimple-stats */
  OPT_ginline_points = 1567,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1568, /* -ginternal-reset-location-views */
  OPT_gnat = 1569,                           /* -gnat */
  OPT_gnatO = 1570,                          /* -gnatO */
  OPT_gno_ = 1571,                           /* -gno- */
  OPT_gno_pubnames = 1572,                   /* -gno-pubnames */
  OPT_gpubnames = 1573,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1574,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1575,                   /* -gsplit-dwarf */
  OPT_gstabs = 1576,                         /* -gstabs */
  OPT_gstabs_ = 1577,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1578,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1579,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1580,                        /* -gtoggle */
  OPT_gvariable_location_views = 1581,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1582,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1583,                           /* -gvms */
  OPT_gxcoff = 1584,                         /* -gxcoff */
  OPT_gxcoff_ = 1585,                        /* -gxcoff+ */
  OPT_gz = 1586,                             /* -gz */
  OPT_gz_ = 1587,                            /* -gz= */
  OPT_h = 1588,                              /* -h */
  OPT_help = 1589,                           /* -help */
  OPT_idirafter = 1590,                      /* -idirafter */
  OPT_imacros = 1591,                        /* -imacros */
  OPT_imultiarch = 1592,                     /* -imultiarch */
  OPT_imultilib = 1593,                      /* -imultilib */
  OPT_include = 1594,                        /* -include */
  OPT_iplugindir_ = 1595,                    /* -iplugindir= */
  OPT_iprefix = 1596,                        /* -iprefix */
  OPT_iquote = 1597,                         /* -iquote */
  OPT_isysroot = 1598,                       /* -isysroot */
  OPT_isystem = 1599,                        /* -isystem */
  OPT_iwithprefix = 1600,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1601,              /* -iwithprefixbefore */
  OPT_k8 = 1602,                             /* -k8 */
  OPT_l = 1603,                              /* -l */
  OPT_lang_asm = 1604,                       /* -lang-asm */
  OPT_list = 1605,                           /* -list */
  OPT_mabi_ = 1606,                          /* -mabi= */
  OPT_malign_data_ = 1607,                   /* -malign-data= */
  OPT_march_ = 1608,                         /* -march= */
  OPT_mblackhole = 1609,                     /* -mblackhole */
  OPT_mbranch_cost_ = 1610,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1611,                       /* -mcmodel= */
  OPT_mcpu_ = 1612,                          /* -mcpu= */
  OPT_mdiv = 1613,                           /* -mdiv */
  OPT_mexplicit_relocs = 1614,               /* -mexplicit-relocs */
  OPT_mfdiv = 1615,                          /* -mfdiv */
  OPT_mgrayskull = 1616,                     /* -mgrayskull */
  OPT_mplt = 1617,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1618,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1619,                         /* -mrelax */
  OPT_mriscv_attribute = 1620,               /* -mriscv-attribute */
  OPT_msave_restore = 1621,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1622,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1623,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1624,                  /* -mstrict-align */
  OPT_mtune_ = 1625,                         /* -mtune= */
  OPT_mwormhole = 1626,                      /* -mwormhole */
  OPT_mwormhole_a0 = 1627,                   /* -mwormhole_a0 */
  OPT_n = 1628,                              /* -n */
