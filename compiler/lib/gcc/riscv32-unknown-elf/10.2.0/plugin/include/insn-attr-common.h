...
enum attr_mode {MODE_UNKNOWN, MODE_NONE, MODE_QI, MODE_HI, MODE_SI, MODE_DI, MODE_TI, MODE_SF, MODE_DF, MODE_TF, MODE_V64SF};
...
enum attr_tune {TUNE_GENERIC, TUNE_SIFIVE_7, TUNE_RVTT_B1};
enum attr_rvtt_type {RVTT_TYPE_NA, RVTT_TYPE_RVTT_L1_LOAD, RVTT_TYPE_RVTT_REG_READ};
