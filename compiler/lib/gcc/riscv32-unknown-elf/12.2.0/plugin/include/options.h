...
enum opt_code
{
  ...
  OPT_frvtt_sfpu_cc = 1484,                  /* -frvtt-sfpu-cc */
  OPT_frvtt_sfpu_combine = 1485,             /* -frvtt-sfpu-combine */
  OPT_frvtt_sfpu_replay = 1486,              /* -frvtt-sfpu-replay */
  OPT_frvtt_sfpu_warn = 1487,                /* -frvtt-sfpu-warn */
  ...
  OPT_list = 1767,                           /* -list */
  OPT_mabi_ = 1768,                          /* -mabi= */
  OPT_malign_data_ = 1769,                   /* -malign-data= */
  OPT_march_ = 1770,                         /* -march= */
  OPT_mbig_endian = 1771,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1772,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1773,                       /* -mcmodel= */
  OPT_mcpu_ = 1774,                          /* -mcpu= */
  OPT_mdiv = 1775,                           /* -mdiv */
  OPT_mexplicit_relocs = 1776,               /* -mexplicit-relocs */
  OPT_mfdiv = 1777,                          /* -mfdiv */
  OPT_mgrayskull = 1778,                     /* -mgrayskull */
  OPT_misa_spec_ = 1779,                     /* -misa-spec= */
  OPT_mlittle_endian = 1780,                 /* -mlittle-endian */
  OPT_mplt = 1781,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1782,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1783,                         /* -mrelax */
  OPT_mriscv_attribute = 1784,               /* -mriscv-attribute */
  OPT_msave_restore = 1785,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1786,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1787,             /* -msmall-data-limit= */
  ...
  OPT_mtune_ = 1792,                         /* -mtune= */
  OPT_mwormhole = 1793,                      /* -mwormhole */
  OPT_mwormhole_a0 = 1794,                   /* -mwormhole_a0 */
  OPT_n = 1795,                              /* -n */
