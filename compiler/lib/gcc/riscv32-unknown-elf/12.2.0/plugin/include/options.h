...
#define TARGET_EXPLICIT_RVTT_BH_P(opts) ((opts->x_flag_blackhole_explicit & OPTION_MASK_RVTT_BH) != 0)
#define SET_TARGET_RVTT_BH(opts) opts->x_flag_blackhole |= OPTION_MASK_RVTT_BH
/* DIV mask */
...
#define TARGET_EXPLICIT_RVTT_GS_P(opts) ((opts->x_flag_grayskull_explicit & OPTION_MASK_RVTT_GS) != 0)
#define SET_TARGET_RVTT_GS(opts) opts->x_flag_grayskull |= OPTION_MASK_RVTT_GS
/* SAVE_RESTORE mask */
...
#define TARGET_EXPLICIT_RVTT_WH_P(opts) ((opts->x_flag_wormhole_explicit & OPTION_MASK_RVTT_WH) != 0)
#define SET_TARGET_RVTT_WH(opts) opts->x_flag_wormhole |= OPTION_MASK_RVTT_WH
...
enum opt_code
{
  ...
  OPT_frvtt_dump_stats = 1484,               /* -frvtt-dump-stats */
  OPT_frvtt_error_multdiv = 1485,            /* -frvtt-error-multdiv */
  OPT_frvtt_gsl1war = 1486,                  /* -frvtt-gsl1war */
  OPT_frvtt_hll = 1487,                      /* -frvtt-hll */
  OPT_frvtt_rmext = 1488,                    /* -frvtt-rmext */
  OPT_frvtt_sfpu_cc = 1489,                  /* -frvtt-sfpu-cc */
  OPT_frvtt_sfpu_combine = 1490,             /* -frvtt-sfpu-combine */
  OPT_frvtt_sfpu_replay = 1491,              /* -frvtt-sfpu-replay */
  OPT_frvtt_sfpu_replay_buffer_size_ = 1492, /* -frvtt-sfpu-replay-buffer-size= */
  OPT_frvtt_sfpu_warn = 1493,                /* -frvtt-sfpu-warn */
  OPT_fsanitize_address_use_after_scope = 1494,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1495,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1496,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1497,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1498,            /* -fsanitize-sections= */
  ...
  OPT_ftransition_vmarkdown = 1610,          /* -ftransition=vmarkdown */
  ...
  OPT_mblackhole = 1778,                     /* -mblackhole */
  OPT_mbranch_cost_ = 1779,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1780,                       /* -mcmodel= */
  OPT_mcpu_ = 1781,                          /* -mcpu= */
  OPT_mdiv = 1782,                           /* -mdiv */
  OPT_mexplicit_relocs = 1783,               /* -mexplicit-relocs */
  OPT_mfdiv = 1784,                          /* -mfdiv */
  OPT_mgrayskull = 1785,                     /* -mgrayskull */
  OPT_misa_spec_ = 1786,                     /* -misa-spec= */
  OPT_mlittle_endian = 1787,                 /* -mlittle-endian */
  OPT_mplt = 1788,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1789,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1790,                         /* -mrelax */
  OPT_mriscv_attribute = 1791,               /* -mriscv-attribute */
  OPT_msave_restore = 1792,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1793,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1794,             /* -msmall-data-limit= */
  ...
  OPT_mwormhole = 1800,                      /* -mwormhole */
  OPT_mwormhole_a0 = 1801,                   /* -mwormhole_a0 */
  OPT_n = 1802,                              /* -n */
