...
enum opt_code
{
  ...
  OPT_mplt = 1605,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1606,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1607,                         /* -mrelax */
  OPT_mriscv_attribute = 1608,               /* -mriscv-attribute */
  OPT_msave_restore = 1609,                  /* -msave-restore */
  OPT_msfpu = 1610,                          /* -msfpu */
